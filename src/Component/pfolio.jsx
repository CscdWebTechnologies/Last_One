import bar_graph from "../Asset/bar_graph.svg";
import date from "../Asset/date.svg";
import v_protect from "../Asset/v_protect.svg";
import phone_apps from "../Asset/phone_apps.svg";
import apps from "../Asset/apps.webp";
	...
	return (
		<a href=" # " className="py-3 grid grid-cols-1 md:grid-cols-7 xl:grid-cols-9 xl:space-x-4 items-start rounded-lg group">
			...
			<div className="col-span-5 md:col-span-6 xl:col-span-7 w-full text-center md:text-justify mt-5 md:mt-0">
				...
				<p className="mt-3 text-sm tracking-wide font- small text-gray-400">
					{text}
				</p>
			</div>
		</a>
			...
			<div className="flex mt-10">
				<div className="w-full grid grid-cols-1 xl:grid-cols-3 xl:gap-x-10 lg:px-20 xl:px-0">
					<div className="col-span-2 block xl:hidden">
						<img src={apps} className="w-full" alt="img" />
					</div>
